...
Install AVD
    ...
    IF    '${os}' == 'Windows'
        ...
        END
    ELSE IF    '${os}' == 'Linux'
        Run Process    ${avd_manager} create avd -n my_avd --path "/usr/local/lib/android/sdk/system-images/android-34/google_apis/x86_64/" --force --device "pixel_xl"    stdout=${avd_install_log}
    END
