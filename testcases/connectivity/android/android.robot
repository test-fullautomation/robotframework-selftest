...
Install AVD
    ...
    IF    '${os}' == 'Windows'
        IF    ${avd.rc} == 1
            ...
            Run Process     "${avd_manager}" create avd -n my_avd -k "platforms;system-images;android-34;google_apis;x86_64" --force --device "pixel_xl"    stdout=${avd_install_log}    stderr=${avd_install_log}     shell=True
            Sleep    5
